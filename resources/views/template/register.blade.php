                ...
                <div class="w-full">
                    ...
                    <form action="{{route('register')}}" method="post">
                        ...
                        <label class="block text-sm mt-4">
                            <span for="name" class="text-gray-700 dark:text-gray-400">Name</span>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="email" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="jane@example.com" />
                        </label>
                    ...
                    <p class="mt-4 text-center">
                        <a class="text-sm  font-medium text-purple-600 dark:text-purple-400 hover:underline" href="{{url('login')}}">
